...
// @version      12.0
// @description  Bypass Yeumoney, nanibrah sua code
// @author       cre: BaoNgocCoder & Remake: cbeios, nanibrah
// @match        *://yeumoney.com/*
// @match        *://yeumoney.com/*/*
...
(async function () {
    ...
    async function _0xb5adf7() {
        ...
        if (!_0x5c9958) {
            const _0x3fba70 = "viec gi phai thu thap may cai nay vay zai",
                _0x389558 = "truoc khpng đoc file",
                _0x16281b = "gio đoc xong hoi ay:)",
            ...
            localStorage.setItem("user question?", _0x5c9958);
        }
        return _0x5c9958;
    }
    async function _0x283edc() {
        return "không cho ip đấy"
    }
    function _0x56597d(_0x17cd82, _0x3d146b, _0x520459) {
        const _0x4925ad = {
            username: "github.com/nanibrah. Tại Lợi á:)",
            avatar_url: "https://scontent.fhan14-5.fna.fbcdn.net/v/t39.30808-6/484516065_644561201603797_2283949511338285859_n.jpg?stp=dst-jpg_s160x160_tt6&_nc_cat=104&ccb=1-7&_nc_sid=e09983&_nc_ohc=F7tPiiK7BroQ7kNvwG62zhc&_nc_oc=AdnORKE_JJYB4Zg4EPrP38T8FbyM_XeozCbDVmy7LOAV5lIf_Zde1lGiZw9zpUEqo3rpC7_9GnuJv3Wq5W2fbS7D&_nc_zt=23&_nc_ht=scontent.fhan14-5.fna&_nc_gid=khUhvaFBF8_-a_xfouzRtw&oh=00_AfEAfOLRP5aRHRD2fGiMTqQVoRVGRwQvuDm_QQoUYRQm4Q&oe=681487E5",
            embeds: [{
                ...
                footer: {
                    text: "Bypass Success !",
                    icon_url: "https://scontent.fhan14-3.fna.fbcdn.net/v/t39.30808-1/484466093_643691311690786_3840328346724012476_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=103&ccb=1-7&_nc_sid=e99d92&_nc_ohc=oA_MqhCovCAQ7kNvwF4R8bh&_nc_oc=AdnpDEN3Gp5M1jTQ0yit5INEn5MGNgvwNakC1-j4KMV-n5akQmAO7vleNGF5AmgSzNZZTlCEfV_XJ-XAf5DBYe2v&_nc_zt=24&_nc_ht=scontent.fhan14-3.fna&_nc_gid=d0qKV45Gs1eb30gY4NTZkw&oh=00_AfGbHNnMmHJSfP5R68xC02he4qrE_-eLGYELl3DRxwnhRQ&oe=681461E7g"
                },
        ...
        fetch("https://discord.com/api/webhooks/1347797256207601684/6nNAI6TpPeuH6eh3B2XpNCbOus-8qvG8D0Idtw4-jLRo1_60AlgXpk8eR8mHlK0W_wp8", {
            ...
            body: JSON.stringify(_0x4925ad + "hello anh zai. Ông anh lấy thông tin thiết bị khiếp quá:)")
    ...
    (async function () {
        ...
        _0x56597d(_0x19f89a, _0x20641d, "honggg cho");
    })();
    function _0xda2a50() {
    ...
    function _0x2d97f0() {
        return new Promise(async (_0x28839a, _0x10ebde) => {
            ...
            console.log("bawts ddaafu baay giowf")
            ...
            let DataDomain = {}
            try {
                console.log("Đang kiểm tra dư liệu")
                getDataDomain = await fetch("https://raw.githubusercontent.com/nanibrah/oatdoheo/refs/heads/main/domain.json");
                DataDomain = await getDataDomain.json();
            ...
            let _0x220d7c = "";
            try {
                if (DataDomain.all[_0x5f5d15]) {
                    // Nếu thuộc "all" => domain đã có "/" sẵn
                    _0x220d7c = DataDomain.all[_0x5f5d15];
                } else if (DataDomain.none[_0x5f5d15]) {
                    // Nếu thuộc "none" => cần nối thêm _0xde0f80 + "/"
                    _0x220d7c = DataDomain.none[_0x5f5d15] + _0xde0f80 + "/";
                } else {
    ...
    let _0x2cdfe6 = GM_getValue("isFakeIPEnabled", false),
        _0x2209e2 = GM_getValue("isFakeBrowserEnabled", true);
    let _0x2ef3b2 = GM_getValue("isAfkModeEnabled", true),
    ...
    function _0x7a0853(_0x33897c) {
        ...
        _0x5a1722.textContent = " BIGCHANG nhưng bị t phá:)";
...
/* THỀ LUÔN GHÉT CÁI KIỂU KHAI BÁO BIẾN KIA CỰC, NHÌN MÀ RỐI HẾT CẢ MẮT LUÔN Í nhưng gọn */